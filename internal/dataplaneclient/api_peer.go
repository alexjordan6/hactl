...
type PeerApiService service

/*
PeerApiService Add a peer
Adds a new peer to the configuration file.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data
 * @param optional nil or *PeerApiCreatePeerOpts - Optional Parameters:
...
type PeerApiCreatePeerOpts struct { 
...
func (a *PeerApiService) CreatePeer(ctx context.Context, data PeerSection, localVarOptionals *PeerApiCreatePeerOpts) (PeerSection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PeerSection
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/peer_section"
...
/*
PeerApiService Delete a peer
Deletes a peer from the configuration by it&#39;s name.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Peer name
 * @param optional nil or *PeerApiDeletePeerOpts - Optional Parameters:
     * @param "TransactionId" (optional.String) -  ID of the transaction where we want to add the operation. Cannot be used when version is specified.
     * @param "Version" (optional.Int32) -  Version used for checking configuration version. Cannot be used when transaction is specified, transaction has it&#39;s own version.
     * @param "ForceReload" (optional.Bool) -  If set, do a force reload, do not wait for the configured reload-delay. Cannot be used when transaction is specified, as changes in transaction are not applied directly to configuration.
...
type PeerApiDeletePeerOpts struct { 
	TransactionId optional.String
	Version optional.Int32
	ForceReload optional.Bool
}

func (a *PeerApiService) DeletePeer(ctx context.Context, name string, localVarOptionals *PeerApiDeletePeerOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/peer_section/{name}"
...
/*
PeerApiService Return a peer
Returns one peer configuration by it&#39;s name.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Peer name
 * @param optional nil or *PeerApiGetPeerSectionOpts - Optional Parameters:
     * @param "TransactionId" (optional.String) -  ID of the transaction where we want to add the operation. Cannot be used when version is specified.
     * @param "FullSection" (optional.Bool) -  Indicates if the action affects the specified child resources as well
...
type PeerApiGetPeerSectionOpts struct { 
	TransactionId optional.String
	FullSection optional.Bool
}

func (a *PeerApiService) GetPeerSection(ctx context.Context, name string, localVarOptionals *PeerApiGetPeerSectionOpts) (PeerSection, *http.Response, error) {
	var (
...
/*
PeerApiService Return an array of peer_section
Returns an array of all configured peer_section.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PeerApiGetPeerSectionsOpts - Optional Parameters:
     * @param "TransactionId" (optional.String) -  ID of the transaction where we want to add the operation. Cannot be used when version is specified.
     * @param "FullSection" (optional.Bool) -  Indicates if the action affects the specified child resources as well
...
type PeerApiGetPeerSectionsOpts struct { 
	TransactionId optional.String
	FullSection optional.Bool
}

func (a *PeerApiService) GetPeerSections(ctx context.Context, localVarOptionals *PeerApiGetPeerSectionsOpts) (PeerSections, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PeerSections
	)
