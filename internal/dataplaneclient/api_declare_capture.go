...
func (a *DeclareCaptureApiService) CreateDeclareCapture(ctx context.Context, index int32, parentName string, data Capture, localVarOptionals *DeclareCaptureApiCreateDeclareCaptureOpts) (Capture, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/frontends/{parent_name}/captures/{index}"
...
func (a *DeclareCaptureApiService) DeleteDeclareCapture(ctx context.Context, index int32, parentName string, localVarOptionals *DeclareCaptureApiDeleteDeclareCaptureOpts) (*http.Response, error) {
	var (
...
func (a *DeclareCaptureApiService) GetDeclareCapture(ctx context.Context, index int32, parentName string, localVarOptionals *DeclareCaptureApiGetDeclareCaptureOpts) (Capture, *http.Response, error) {
	var (
...
func (a *DeclareCaptureApiService) GetDeclareCaptures(ctx context.Context, parentName string, localVarOptionals *DeclareCaptureApiGetDeclareCapturesOpts) (Captures, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/frontends/{parent_name}/captures"
	localVarPath = strings.Replace(localVarPath, "{"+"parent_name"+"}", fmt.Sprintf("%v", parentName), -1)
...
func (a *DeclareCaptureApiService) ReplaceDeclareCapture(ctx context.Context, index int32, parentName string, data Capture, localVarOptionals *DeclareCaptureApiReplaceDeclareCaptureOpts) (Capture, *http.Response, error) {
	var (
...
/*
DeclareCaptureApiService Replace a declare capture list
Replaces a whole list of declare capture with the list given in parameter
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param parentName Parent name
 * @param data
 * @param optional nil or *DeclareCaptureApiReplaceDeclareCapturesOpts - Optional Parameters:
     * @param "TransactionId" (optional.String) -  ID of the transaction where we want to add the operation. Cannot be used when version is specified.
     * @param "Version" (optional.Int32) -  Version used for checking configuration version. Cannot be used when transaction is specified, transaction has it&#39;s own version.
     * @param "ForceReload" (optional.Bool) -  If set, do a force reload, do not wait for the configured reload-delay. Cannot be used when transaction is specified, as changes in transaction are not applied directly to configuration.
...
type DeclareCaptureApiReplaceDeclareCapturesOpts struct { 
	TransactionId optional.String
	Version optional.Int32
	ForceReload optional.Bool
}

func (a *DeclareCaptureApiService) ReplaceDeclareCaptures(ctx context.Context, parentName string, data Captures, localVarOptionals *DeclareCaptureApiReplaceDeclareCapturesOpts) (Captures, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
