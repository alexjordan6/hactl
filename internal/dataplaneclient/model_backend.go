...
type Backend struct {
	...
	ForcePersist *BackendBaseForcePersist `json:"force_persist,omitempty"`
	ForcePersistList []BackendBaseForcePersistList `json:"force_persist_list,omitempty"`
	...
	HashBalanceFactor int32 `json:"hash_balance_factor,omitempty"`
	...
	IgnorePersist *BackendBaseIgnorePersist `json:"ignore_persist,omitempty"`
	IgnorePersistList []BackendBaseIgnorePersistList `json:"ignore_persist_list,omitempty"`
	...
	ServerTemplates interface{} `json:"server_templates,omitempty"`
