...
func (a *BackendSwitchingRuleApiService) CreateBackendSwitchingRule(ctx context.Context, index int32, parentName string, data BackendSwitchingRule, localVarOptionals *BackendSwitchingRuleApiCreateBackendSwitchingRuleOpts) (BackendSwitchingRule, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/frontends/{parent_name}/backend_switching_rules/{index}"
...
func (a *BackendSwitchingRuleApiService) DeleteBackendSwitchingRule(ctx context.Context, index int32, parentName string, localVarOptionals *BackendSwitchingRuleApiDeleteBackendSwitchingRuleOpts) (*http.Response, error) {
	var (
...
func (a *BackendSwitchingRuleApiService) GetBackendSwitchingRule(ctx context.Context, index int32, parentName string, localVarOptionals *BackendSwitchingRuleApiGetBackendSwitchingRuleOpts) (BackendSwitchingRule, *http.Response, error) {
	var (
...
func (a *BackendSwitchingRuleApiService) GetBackendSwitchingRules(ctx context.Context, parentName string, localVarOptionals *BackendSwitchingRuleApiGetBackendSwitchingRulesOpts) (BackendSwitchingRules, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/configuration/frontends/{parent_name}/backend_switching_rules"
	localVarPath = strings.Replace(localVarPath, "{"+"parent_name"+"}", fmt.Sprintf("%v", parentName), -1)
...
func (a *BackendSwitchingRuleApiService) ReplaceBackendSwitchingRule(ctx context.Context, index int32, parentName string, data BackendSwitchingRule, localVarOptionals *BackendSwitchingRuleApiReplaceBackendSwitchingRuleOpts) (BackendSwitchingRule, *http.Response, error) {
	var (
...
/*
BackendSwitchingRuleApiService Replace an Backend Switching Rule list
Replaces a whole list of Backend Switching Rules with the list given in parameter
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param parentName Parent name
 * @param data
 * @param optional nil or *BackendSwitchingRuleApiReplaceBackendSwitchingRulesOpts - Optional Parameters:
     * @param "TransactionId" (optional.String) -  ID of the transaction where we want to add the operation. Cannot be used when version is specified.
     * @param "Version" (optional.Int32) -  Version used for checking configuration version. Cannot be used when transaction is specified, transaction has it&#39;s own version.
     * @param "ForceReload" (optional.Bool) -  If set, do a force reload, do not wait for the configured reload-delay. Cannot be used when transaction is specified, as changes in transaction are not applied directly to configuration.
...
type BackendSwitchingRuleApiReplaceBackendSwitchingRulesOpts struct {
	TransactionId optional.String
	Version       optional.Int32
	ForceReload   optional.Bool
}

func (a *BackendSwitchingRuleApiService) ReplaceBackendSwitchingRules(ctx context.Context, parentName string, data BackendSwitchingRules, localVarOptionals *BackendSwitchingRuleApiReplaceBackendSwitchingRulesOpts) (BackendSwitchingRules, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
